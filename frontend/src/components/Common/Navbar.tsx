...
const Navbar: React.FC = () => {
  ...
  const inactiveClassName =
    "text-indigo-100 hover:bg-indigo-500 hover:bg-opacity-75 px-3 py-2 rounded-md text-sm font-medium";

  return (
    <nav className="bg-black opaccity-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 text-white font-bold text-xl">
              <img src="/logo.svg" alt="Studafishka" width={100} />
            </Link>
              ...
              {isAuthenticated ? (
                ...
                <div className="space-x-2">
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className="text-white border-indigo-400 hover:bg-indigo-500 hover:bg-opacity-75"
                  >
                    Регистрация
                  </Button>
                </div>
